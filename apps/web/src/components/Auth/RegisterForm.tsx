...
export const RegisterForm: FC<RegisterFormProps> = ({ onSwitchToLogin }) => {
  ...
  return (
    <form onSubmit={handleRegister} className="space-y-4">
      <h2 className="text-2xl font-bold text-zinc-900 mb-6">Crear Cuenta</h2>
      ...
      <div>
        ...
        <div className="relative">
          <input
            ...
            className={`w-full px-4 py-2 pr-10 border rounded-lg bg-white text-zinc-900 placeholder-zinc-400 focus:ring-2 focus:border-transparent ${
              password.length === 0
