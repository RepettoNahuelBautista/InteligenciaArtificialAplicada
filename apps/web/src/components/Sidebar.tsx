...
export function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className="flex flex-col h-screen bg-zinc-950 border-r border-zinc-800 shrink-0 overflow-hidden z-20"
    >
      ...
      <div className="flex items-center justify-between px-4 py-5 border-b border-zinc-800">
        ...
        <button
          ...
          className="text-zinc-400 hover:text-white transition p-1 rounded-lg hover:bg-zinc-800 ml-auto"
      ...
      <div className="border-t border-zinc-800 p-3">
        ...
        <button
          ...
          title="Cerrar sesión"
          className={`mt-2 flex items-center gap-2 w-full px-2 py-2 rounded-lg text-zinc-400 hover:text-red-400 hover:bg-zinc-800 transition text-sm font-medium ${collapsed ? 'justify-center' : ''}`}
        >
