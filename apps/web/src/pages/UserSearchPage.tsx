    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-900 p-4 sm:p-8">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">Buscar usuarios</h1>
          <p className="text-indigo-300 mt-1">Encontrá usuarios por su nombre y seguílos</p>
        </div>
        ...
        {results.length > 0 ? (
            ...
            {results.map((u) => (
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-indigo-300 text-sm truncate">{u.email}</p>
                </div>
          ...
          <div className="text-center py-16 text-indigo-300">
            ...
            <p className="text-sm mt-1 text-indigo-400">Solo se puede buscar a usuarios que configuraron su nombre de usuario</p>
          </div>
        ) : (
          <div className="text-center py-16 text-indigo-300">
            <p className="text-5xl mb-4">👥</p>
