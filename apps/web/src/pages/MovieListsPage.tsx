      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-indigo-300 mt-1">Organizá tus películas y series en listas personalizadas</p>
            </div>
            <button
        ...
        {loading ? (
          ...
          <div className="text-center py-16 text-indigo-300">
            ...
            <p className="font-medium text-white mb-1">Aún no tenés listas</p>
          ...
          <div className="space-y-3">
            {lists.map((list) => (
              <button
                ...
                className="w-full text-left bg-white/10 backdrop-blur-md rounded-xl border border-white/20 p-5 hover:bg-white/20 transition"
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    ...
                    {list.description && (
                      <p className="text-indigo-300 text-sm truncate">{list.description}</p>
                    )}
                  </div>
                  <div className="flex-shrink-0 text-right">
                    <p className="text-white font-bold">{list.itemCount}</p>
